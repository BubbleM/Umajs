...
import { TMethodInfo } from '../types/TMethodInfo.ts';
import { IHelper } from '../types/IHelper.ts';
 ...
 */
function setControllersInfo(clazz: Function, methodName: string | null, info: IHelper = {}) {
